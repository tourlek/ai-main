...
3. Audit `oho-api`.
   ...
   - Check bulk-send and reply paths for timestamp source, delivery-success guards, and broadcast wiring.
4. Audit `oho-websocket`.
   ...
   - Treat `channel-eligible-members.js` cache TTL, null behavior, and concurrency as correctness/security concerns.
5. Audit `oho-web-app`.
